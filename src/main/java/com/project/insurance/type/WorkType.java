...
public enum WorkType {
	...
	IP(new String[]{"보험 설계하기", "보험상품 관리하기"}, new String[]{"/product/design/CANCER",""}),
	IPA(new String[]{"보험상품 승인하기", "보험상품 삭제하기"}, new String[]{"/product/list/acceptance",""}),
	...
	SP(new String[]{"영업 활동 관리", "계약가능 보험조회"}, new String[]{"","/product/list/salesperson"}),
