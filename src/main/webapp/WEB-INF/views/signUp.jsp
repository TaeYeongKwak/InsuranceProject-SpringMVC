		            ...
		            <div class="input-group mb-3 mt-3 input_interval">
		                ...
		                <div class="row">
		                    <div class="col radio_item_container">
		                        <label class="form-check-label" for="male">남자 <input type="radio" id="male" name="gender" value="true" checked></label>
		                    </div>
		                    <div class="col radio_item_container">
		                        <label class="form-check-label" for="female">여자 <input type="radio" id="female" name="gender" value="false"></label>
		                    </div>
		                </div>
		            </div>
		            <div class="input-group mb-3 mt-3 input_interval">
		        ...
		        <form action="ManagerRegist" class="was-validated" method="post">
		            <div class="input-group mb-3 mt-3 input_interval">
		                ...
		                <select class="form-select" id="job" name="jobPosition">
		                    ...
		                    <option>3.U/W</option>
		                    <option>4.계약관리자</option>
		                    <option>5.보상처리자</option>
		                    <option>6.영업사원</option>
		                </select>
		            </div>
		            <div class="input-group mb-3 mt-3">
		                <span class="input-group-text input_span">ID</span>
		                <input type="text" class="form-control" id="uname" placeholder="Enter ID" name="email" required pattern="^[a-zA-Z0-9]+$">
		                <button class="btn btn-primary" type="button">Check ID</button>
		                <div class="valid-feedback">Valid.</div>
		                <div class="invalid-feedback">Please fill out this field.</div>
		            </div>
